...
export function BulkAssignTasksDialog({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create assignments for all selected students and tasks combinations
      const assignments = [];
      ...
      toast.success(`Tasks assigned to ${selectedStudents.size} student${selectedStudents.size > 1 ? 's' : ''}`);
      onOpenChange(false);
      onTasksAssigned();
    } catch (error: any) {
      console.error("Error assigning tasks:", error);
      toast.error(error.message || "Failed to assign tasks. Please try again.");
    } finally {
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                placeholder="Add any notes for these task assignments"
                rows={3}
              />
            </div>
          </div>
