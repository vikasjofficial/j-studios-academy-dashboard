...
export function AttendanceCard({ title, percentage, present, total, className }: AttendanceCardProps) {
  ...
  return (
    <div 
      className={cn(
        "relative p-6 rounded-xl overflow-hidden glass-morphism transition-all duration-300",
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-primary/20 text-primary group-hover:bg-primary/50 group-hover:text-white transition-all duration-300">
            <CheckSquare className="h-5 w-5" />
          </div>
        </div>
        
        <div className="flex items-center justify-between mb-4">
          <span className="text-3xl font-bold group-hover:text-white transition-colors duration-300">{percentage}%</span>
        ...
        <div className="grid grid-cols-3 gap-3 mt-6">
          <div className="flex flex-col items-center p-3 rounded-lg bg-black/20 border border-white/10 group-hover:border-white/30 transition-colors duration-300">
            <span className="text-xs text-muted-foreground mb-1 group-hover:text-white/70 transition-colors duration-300">Present</span>
            <span className="font-medium group-hover:text-white transition-colors duration-300">{present}</span>
          </div>
          <div className="flex flex-col items-center p-3 rounded-lg bg-black/20 border border-white/10 group-hover:border-white/30 transition-colors duration-300">
            <span className="text-xs text-muted-foreground mb-1 group-hover:text-white/70 transition-colors duration-300">Absent</span>
            <span className="font-medium group-hover:text-white transition-colors duration-300">{total - present}</span>
          </div>
          <div className="flex flex-col items-center p-3 rounded-lg bg-black/20 border border-white/10 group-hover:border-white/30 transition-colors duration-300">
            <span className="text-xs text-muted-foreground mb-1 group-hover:text-white/70 transition-colors duration-300">Total</span>
            <span className="font-medium group-hover:text-white transition-colors duration-300">{total}</span>
          </div>
        </div>
      </div>
    </div>
